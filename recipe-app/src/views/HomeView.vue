      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="">
          ...
          <div class="group">
            ...
            <div v-for="i in newRecipe.ingridientRows" :key="i" class="ingridient">
              <input v-model="newRecipe.ingridient" type="text">
            </div>
            <button @click="addNewIngridient" type="button">Add Ingridient</button>
          </div>
...
export default {
  ...
  setup() {
    ...
    const addNewIngridient = () => {
      newRecipe.value.ingridientRows++;
    }
